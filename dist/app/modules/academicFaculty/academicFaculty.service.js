...
const createFacultyToDB = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield academicFaculty_model_1.AcademicFaculty.create(payload);
    return result;
});
const getAllFacultyFromDB = (paginationOptions, filters) => __awaiter(void 0, void 0, void 0, function* () {
